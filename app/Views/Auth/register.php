    ...
    <div class="card col-12 col-md-5 shadow-sm">
        <div class="card-body">
            ...
            <form action="<?= url_to('auth/register') ?>" method="post">
                ...
                <!-- Firstname -->
                <div class="mb-2">
                    <input type="text" class="form-control" name="firstname" inputmode="text" autocomplete="firstname"
                           placeholder="<?= lang('Auth.firstname') ?>" value="<?= old('firstname') ?>" required/>
                </div>

                <!-- lastname -->
                <div class="mb-4">
                    <input type="text" class="form-control" name="lastname" inputmode="text" autocomplete="lastname"
                           placeholder="<?= lang('Auth.lastname') ?>" value="<?= old('lastname') ?>" required/>
                </div>
                ...
                <p class="text-center"><?= lang('Auth.haveAccount') ?> <a
                            href="<?= url_to('auth/login') ?>"><?= lang('Auth.login') ?></a></p>
